  ...
  return (
    <div className="min-h-screen bg-black text-white px-6 py-12 md:px-20 font-sans">
      <div className="flex items-center justify-center gap-3 mb-8">
        <Contact className="w-8 h-8 text-whtie-400" />
        ...
        <div className="bg-gray-800 p-6 rounded-xl shadow-lg space-y-6">
          <div className="flex items-start space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-300">Cubeesec groups, GN Krishna Nagar,<br></br> Pongupalayam, Kanalampalayam,<br></br> Tirupur, India</p>
            </div>
          </div>
          <div className="flex items-start space-x-4">
            <div className="p-2 bg-gray-700 rounded-lg">
